    ...
    <header className="fixed top-0 inset-x-0 z-50 h-16 backdrop-blur-md bg-cream/70 border-b border-charcoal/10">
      <div className="container h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/login"
            className="hidden sm:inline-flex items-center px-4 h-9 rounded-full text-sm font-medium text-charcoal border border-charcoal/15 hover:bg-charcoal/5 transition"
          >
            Log in
          </Link>
          <Link
            to="/login"
            className="inline-flex items-center px-4 h-9 rounded-full text-sm font-semibold bg-coral text-cream hover:bg-charcoal transition"
          >
            Start free trial
          </Link>
        </div>
