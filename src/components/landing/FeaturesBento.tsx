    ...
    <section className="py-24">
      <div className="container max-w-6xl">
        <div className="text-center mb-12">
          <div className="text-xs font-medium text-ink-muted uppercase tracking-wider">// Features //</div>
          <h2 className="mt-2 font-display font-bold text-4xl sm:text-5xl text-ink">
            Every part of screening, <span className="italic text-forest">automated.</span>
          </h2>
        </div>

        <div className="grid md:grid-cols-3 gap-5">
          {/* Wide card */}
          <div className="md:col-span-2 rounded-3xl bg-forest text-cream p-8 relative overflow-hidden border border-forest">
            <div className="absolute -bottom-32 -right-20 w-80 h-80 lime-glow opacity-40" />
            <div className="relative grid sm:grid-cols-2 gap-6 items-center">
              <div>
                <div className="h-11 w-11 rounded-2xl bg-lime text-forest flex items-center justify-center mb-4">
              ...
              <div className="bg-white/5 backdrop-blur border border-cream/10 rounded-2xl p-5">
                <div className="text-[11px] uppercase tracking-wider text-lime mb-2">Question 3 of 6</div>
...
const FeatureCard = ({ icon: Icon, title, body }: { icon: any; title: string; body: string }) => (
  <div className="rounded-3xl border border-ink/10 bg-white p-6 flex flex-col">
    <div className="h-10 w-10 rounded-xl bg-cream border border-ink/10 flex items-center justify-center mb-4 text-forest">
