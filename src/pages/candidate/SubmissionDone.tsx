              ...
              <div className="bg-cream/30 rounded-xl p-4 text-left space-y-3 border border-charcoal/5">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[12px] font-semibold text-charcoal">Video interview — 8 questions answered</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-4 w-4 rounded-full bg-[#00CC88]/10 text-[#00CC88] flex items-center justify-center shrink-0">
                      <Check className="h-2.5 w-2.5" />
                    </div>
                    <span className="text-[12px] font-semibold text-charcoal">Skills assessment — 20 questions · 1 coding problem</span>
                  </div>
                </div>
              </div>
